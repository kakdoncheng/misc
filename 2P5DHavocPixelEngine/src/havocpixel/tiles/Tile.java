...
public class Tile {
	...
	public static Tile ab=new FormlessTile(Assets.textures[1][1],27,true,"0f0f0f","TILE:EmptySlot");
	public static Tile ac=new FormlessTile(Assets.textures[2][1],28,false,"191919","TILE:EmptySlot");
	public static Tile ad=new FormlessTile(Assets.textures[3][1],29,false,"232323","TILE:EmptySlot");
	public static Tile ae=new FormlessTile(Assets.textures[4][1],30,false,"2d2d2d","TILE:EmptySlot");
	public static Tile af=new FormlessTile(Assets.textures[5][1],31,false,"373737","TILE:EmptySlot");
	...
	public static Tile am=new FormlessTile(Assets.textures[12][1],38,false,"7d7d7d","TILE:EmptySlot");

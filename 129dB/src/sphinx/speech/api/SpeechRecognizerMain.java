...
public class SpeechRecognizerMain {
	...
	/**
	 * Checks if the speech recognition is already running
	 */
	...
	public SpeechRecognizerMain() {
		...
		// Some speech science stuff that can translate text into how its supposed to sound in english
		configuration.setAcousticModelPath("resource:/edu/cmu/sphinx/models/en-us/en-us");
		// Giant ass dictionary included in api
					...
					while (speechRecognizerThreadRunning) {
						...
						if (!ignoreSpeechRecognitionResults) {
							...
							if (speechResult == null)
								...
								//Audio Volume
								//System.out.println("Audio Volume: " + recognizer.getMicrophone().getAudioVolume());
								...
								//End recognition if needed.
								//if(speechRecognitionResult.equalsIgnoreCase("end"))
									//break;
	 ...
	 * (ensures microphone is available and config was properly set up)
	 */
